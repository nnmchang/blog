...
<div class="flex flex-col flex-nowrap justify-center xl:flex-row xl:flex-wrap h-feed">
  <div
    ...
    class="flex-1 w-full page-container order-first mx-auto xl:mr-0 xl:ml-8">
    <Profile />
  </div>
  <div
    in:fly={{ x: -25, duration: 300, delay: 500 }}
    out:fly={{ x: -25, duration: 300 }}
    class="flex-1 w-full page-container xl:order-last mx-auto xl:ml-0 xl:mr-8">
  ...
  <div class="flex-none w-full page-container mx-auto xl:mx-0 xl:mr-8">
    {#key posts}
